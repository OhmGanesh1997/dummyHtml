...
API_KEY = "sk-IiAZhl663g42xh4Rw0TIag"   # from the PDF

MODEL = "kimi-vibecoder"                # coder model (use "kimi-gpm" if you want general purpose)

ENDPOINT = "https://api.startflow.org/v1"
